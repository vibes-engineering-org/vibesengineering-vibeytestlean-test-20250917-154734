...
export async function GET() {
  const farcasterManifest = {
    accountAssociation: {
      ...
      signature:
        "MHhiMTNkYTNlYjhiNzUzNDE5N2RiYzc4OWI5ODFlNWE5NjYzMTg4NGNhN2ExODJiODZjZWI1NjJmNzJiMzVhM2Q1MTVlOWNlMmUyMjllMmFiM2I5MTdhMmMxNGJhYWNjNjc2OTU0MmVjMDA1YmMyMTgyYmQ3ZDM1MjAxN2ViODVkZTFj",
    },
    miniapp: {
      version: "1",
